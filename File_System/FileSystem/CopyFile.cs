...
public class CopyFile : CommandHandler
{
    private readonly FileNavigator _fileNavigator;
    private readonly IFileSystem _fileSystem;
    private readonly IOutPutFactory _outputFactory;

    public CopyFile(FileNavigator fileNavigator, IFileSystem fileSystem, IOutPutFactory outputFactory)
    {
    ...
    {
        return input.CommandName == "file copy";
    }
    ...
    protected override void Execute(SetContext input)
    {
        ...
        _fileSystem.CopyFile(absoluteSourcePath, _fileSystem.CombinePath(absoluteDestinationPath, _fileSystem.GetFileName(absoluteSourcePath)));
        console.Output("File copied to " + destinationPath.Path);
    }
}